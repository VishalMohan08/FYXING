...
export default function PS5(){
    return (
      ...
      <p></p>
        ...
        <div className="box30">
          <form>
            <h1 className="font30">PS5 Service</h1>
            <h2 className="subfont30">Choose your console :</h2>
            <label className="firstdrop30">
              Model:
              <br />
              <select
                required
                className="firstlist30"
                name="consoles"
                id="consoles">
            ...
            <br />
            <br />
            <label className="secondrop30">
              Issue:
              <br />
              <select
                required
                className="secondlist30"
                name="consoles"
                id="consoles">
                <option value="" disabled selected>
            ...
            <div className="selectcunt30">
              ...
              <select
                required
                className="selectcuntposition30"
                id="country"
                name="country">
                <option value="" disabled selected>
                  Select country
            ...
            <div className="seriall30">
              <label className="serialnum30">
                Serial number:
                <br />
              </label>
              <InputBox
            ...
            <div className="finarr30">
            <Link to ="/ContactDetails">
              <input className="button30" type="submit" value="NEXT" />
              </Link>
            </div>
          </form>
        </div>
